...
static const float TERRAIN_TILE_FREQ 			= 256.0f;
...
static const float GB_CAM_MAX_FILLING_CLAMP = 0.90f; // 0 to 1 value for clamping the fill when camera is at max distance
